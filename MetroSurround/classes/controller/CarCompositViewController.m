...
#import "CarCompositSmallCell.h"


@interface CarCompositViewController ()
...
@implementation CarCompositViewController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"CarCompositCell" bundle:nil] forCellReuseIdentifier:@"CarCompositCell"];
    [self.tableView registerNib:[UINib nibWithNibName:@"CarCompositSmallCell" bundle:nil] forCellReuseIdentifier:@"CarCompositSmallCell"];
    [self.tableView registerClass:[CarCompositHeader class] forHeaderFooterViewReuseIdentifier:@"CarCompositHeader"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if([transInfoLabel[@"isHide"] boolValue] && [surroundInfoLabel[@"isHide"] boolValue]){
        ...
        CarCompositSmallCell *cell = [tableView dequeueReusableCellWithIdentifier:@"CarCompositSmallCell" forIndexPath:indexPath];
        ...
        CarCompositCell *cell = [tableView dequeueReusableCellWithIdentifier:@"CarCompositCell" forIndexPath:indexPath];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    CarCompositHeader *headerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:@"CarCompositHeader"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CarCompositDetailViewController *vc = [stBoard instantiateViewControllerWithIdentifier:@"CarCompositDetailViewController"];
